            ...
            <div class="well orders-right-pane form-horizontal">
                ...
                {if $order_info.shipping}
                    ...
                    {foreach from=$order_info.shipping item="shipping" key="shipping_id" name="f_shipp"}
                        ...
                        {if $shipping.module == 'qwintry' && !empty($shipping.extra) && !empty($shipping.extra.type)}
                            <div class="control-group">
                                <div class="control-label">{__("type")}</div>
                                <div class="controls">
                                    {__("qwintry_`$shipping.extra.type`")}
                                </div>
                            </div>
                            {if $shipping.extra.type == 'pickup' && !empty($shipping.extra.point)}
                                <div class="control-group">
                                    <div class="control-label">{__("qwintry_pickup_point")}</div>
                                    <div class="controls">
                                        {$shipping.extra.point|fn_qwintry_get_address_by_pickup_point:$shipping.shipping_id}
                                    </div>
                                </div>
                            {/if}
                        {/if}
                        {if $shipping.module == 'qwintry'}
                            {assign var="qwintry_label" value=$order_info.order_id|fn_qwintry_check_label}
                            {if $qwintry_label}
                                <div class="clearfix">
                                    <div class="pull-left">
